...
|---|---|---|
| [anthropic](https://github.com/anthropics/anthropic-sdk-python) (Python SDK) | MIT | `research.score`: judge calls (`AsyncAnthropic.messages.create`). Already a repo dep (engine). |
| [python-dotenv](https://github.com/theskumar/python-dotenv) | BSD-3-Clause | `research.score`, `research.llm`: loads the repo-root `.env`. Added with `uv add python-dotenv`. |
